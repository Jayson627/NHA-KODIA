...
@media (max-width: 576px) {
 /* Ensure the navbar items are visible on all screen sizes */
.navbar-nav {
  display: flex;
  flex-direction: row;
}
...
/* Ensure the collapse behavior works correctly */
.navbar-collapse {
...
<body class="hold-transition">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="resident.php"><i class="fas fa-users"></i> Residents</a>
      </li>
      <li class="nav-item">
