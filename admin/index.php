<?php
// Include the authentication check at the top of the file
include 'auth_check.php'; // This file should handle the authentication logic (session check, token verification, etc.)
      ...
      <div class="content-wrapper pt-3" style="min-height: 567.854px;">
        ...
        <section class="content ">
          <div class="container-fluid">
            <?php 
              // Dynamically include the requested page or display 404 error if not found
