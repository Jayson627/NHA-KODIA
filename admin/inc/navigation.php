...
.sidebar-dark-primary .nav-sidebar>.nav-item>.nav-link.active {
    background-color: #007bff; /* Bright blue for active links */
    color: #fff;
}
.sidebar-dark-primary .nav-sidebar>.nav-item>.nav-link {
    color: #495057; /* Medium-dark text for contrast */
}
.sidebar-dark-primary .nav-sidebar>.nav-item>.nav-link:hover {
    background-color: #e2e6ea; /* Light hover effect */
    color: #007bff; /* Bright blue for hover text */
}
.brand-link {
    background-color: #4f6d7a; /* Muted blue background for brand link */
    color: #f8f9fa; /* Light text for contrast */
}
.nav-icon {
    color: #6c757d; /* Lighter color for icons */
}
.nav-icon:hover {
    color: #007bff; /* Bright blue for icon hover effect */
}
</style>

<!-- Main Sidebar Container -->
<aside class="main-sidebar sidebar-dark-primary elevation-4 sidebar-no-expand bg-light">
    <!-- Brand Logo -->
                ...
                <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                    ...
                    <nav class="mt-4">
                        <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item">
    <a href="<?php echo base_url ?>admin/?page=accounts" class="nav-link nav-admin_accounts">
