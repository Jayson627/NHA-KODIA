...
<body>
  <div class="container d-flex justify-content-center align-items-center h-100">
    <div class="card">
      ...
      <div class="card-body">
      <form action="../admin/funtion.php" method="post"> <!-- Update action here -->
  <!-- OTP Code Input -->
  ...
  <!-- Submit Button -->
  <button type="submit" class="btn btn-primary" name="btn-new-password">Reset Password</button> <!-- Use correct button name -->
</form>
